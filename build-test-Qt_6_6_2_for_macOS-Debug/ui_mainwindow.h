...
public:
    ...
    QLabel *label_6;
    CanvasWidget *canvas;
    QGroupBox *showFoldedFormGroupBox;
    QHBoxLayout *horizontalLayout;
    QLabel *showFoldedFormLabel;
    QToolButton *showFoldedFormButton;
    QGroupBox *foldedFormImageGroupBox;
    QLabel *foldedFormImage;
    QGroupBox *hideFoldedFormGroupBox;
    QHBoxLayout *horizontalLayout_2;
    QLabel *hideFoldedFormLabel;
    QToolButton *hideFoldedFormButton;
    QMenuBar *menubar;
    QMenu *menuFile;
    QMenu *menuEdit;
    QMenu *menuView;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        showFoldedFormGroupBox = new QGroupBox(canvas);
        showFoldedFormGroupBox->setObjectName("showFoldedFormGroupBox");
        showFoldedFormGroupBox->setGeometry(QRect(10, 70, 241, 51));
        horizontalLayout = new QHBoxLayout(showFoldedFormGroupBox);
        horizontalLayout->setObjectName("horizontalLayout");
        showFoldedFormLabel = new QLabel(showFoldedFormGroupBox);
        showFoldedFormLabel->setObjectName("showFoldedFormLabel");

        horizontalLayout->addWidget(showFoldedFormLabel);

        showFoldedFormButton = new QToolButton(showFoldedFormGroupBox);
        showFoldedFormButton->setObjectName("showFoldedFormButton");
        showFoldedFormButton->setArrowType(Qt::DownArrow);

        horizontalLayout->addWidget(showFoldedFormButton);

        foldedFormImageGroupBox = new QGroupBox(canvas);
        foldedFormImageGroupBox->setObjectName("foldedFormImageGroupBox");
        foldedFormImageGroupBox->setGeometry(QRect(10, 70, 241, 151));
        foldedFormImage = new QLabel(foldedFormImageGroupBox);
        foldedFormImage->setObjectName("foldedFormImage");
        foldedFormImage->setGeometry(QRect(0, 0, 241, 151));
        foldedFormImage->setPixmap(QPixmap(QString::fromUtf8(":/images/folded_image.jpg")));
        foldedFormImage->setScaledContents(true);
        hideFoldedFormGroupBox = new QGroupBox(canvas);
        hideFoldedFormGroupBox->setObjectName("hideFoldedFormGroupBox");
        hideFoldedFormGroupBox->setGeometry(QRect(10, 220, 241, 51));
        horizontalLayout_2 = new QHBoxLayout(hideFoldedFormGroupBox);
        horizontalLayout_2->setObjectName("horizontalLayout_2");
        hideFoldedFormLabel = new QLabel(hideFoldedFormGroupBox);
        hideFoldedFormLabel->setObjectName("hideFoldedFormLabel");

        horizontalLayout_2->addWidget(hideFoldedFormLabel);

        hideFoldedFormButton = new QToolButton(hideFoldedFormGroupBox);
        hideFoldedFormButton->setObjectName("hideFoldedFormButton");
        hideFoldedFormButton->setArrowType(Qt::DownArrow);

        horizontalLayout_2->addWidget(hideFoldedFormButton);

        foldedFormImageGroupBox->raise();
        showFoldedFormGroupBox->raise();
        hideFoldedFormGroupBox->raise();
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        showFoldedFormGroupBox->setTitle(QString());
        showFoldedFormLabel->setText(QCoreApplication::translate("MainWindow", "Show Folded View", nullptr));
        showFoldedFormButton->setText(QCoreApplication::translate("MainWindow", "...", nullptr));
        foldedFormImageGroupBox->setTitle(QString());
        foldedFormImage->setText(QString());
        hideFoldedFormGroupBox->setTitle(QString());
        hideFoldedFormLabel->setText(QCoreApplication::translate("MainWindow", "Hide Folded View", nullptr));
        hideFoldedFormButton->setText(QCoreApplication::translate("MainWindow", "...", nullptr));
